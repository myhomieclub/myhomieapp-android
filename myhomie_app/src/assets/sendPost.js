...
let contact = {name: 'Contact', unit: '', placeholder: 'Please enter your contact information', isUnfold: false, isReadonly: false, value: '', category: []};
/////活动
let events = [
    ...
    {name: 'Number', unit: '', placeholder: 'Please enter the number of people required', isUnfold: false, isReadonly: false, value: '', category: []},
    contact,
];
/////旅游
let travel = [
...
let house = [
    ...
    {name: 'Price', unit: '$', placeholder: 'Please enter the price / per month', isUnfold: false, isReadonly: false, value: '', category: []},
    contact
];
/////二手
let secondHand = [
...
let sales = [
    ...
    {name: 'Country of origin', unit: '', placeholder: 'Please enter the original country of the goods', isUnfold: false, isReadonly: false, value: '', category: []},
    {name: 'Price', unit: '$', placeholder: 'unit: $', isUnfold: false, isReadonly: false, value: '', category: []},
    contact,
];
/////招聘
let recruitment = [
    ...
    {name: 'Salary', unit: '$', placeholder: 'Please enter salary / per month', isUnfold: false, isReadonly: false, value: '', category: []},
    {name: 'Company', unit: '', placeholder: 'Please enter the name of company', isUnfold: false, isReadonly: false, value: '', category: []},
    {name: 'Position', unit: '', placeholder: 'Please enter the name of the job', isUnfold: false, isReadonly: false, value: '', category: []},
    {name: 'Posted by', unit: '', placeholder: 'Please choose the source of information', isUnfold: true, isReadonly: true, value: '',  
      category: [
        {name: 'Individual', isCheck: false, index: 0},
        {name: 'Merchants', isCheck: false, index: 1},
        {name: 'Myhomie', isCheck: false, index: 2},
    ]},
    {name: 'Visa status', unit: '', placeholder: 'Please enter the visa status', isUnfold: false, isReadonly: false, value: '', category: []},
    contact,
];
export {
