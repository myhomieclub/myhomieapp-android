...
/*举报相关*/
export default {
	login, register, resetPass, sendSMS, getImgCode, isLogin, logout, loginViaw,
	getUserInfo, updateUserInfo, getUsers, getUserInfoById, getPMList, getPM, message, delAComment,
	uploadImg, uploadVideo, sendPost,
	queryPosts, queryPostDetail, getGroupComments, getCommentReplies, delPost,
	likePost, likeComment, isPostLiked, isCommentLiked, queryLikes, getCommentDetail, commentAPost, getMyComments, getReceivedComments, fav, isFav, addToFav, deleteAFav, getAllFav,
	queryPostsBySearchItem, getAllAvailableSearches, getHotSearch, deleteASearch, deleteAllSearches,
	reportAPost, reportAComment
}
