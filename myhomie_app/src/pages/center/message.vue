	...
	<section class="message">
	    ...
	    <div class="container">
	        <swiper ref="mySwiper" :options="swiperOption">
			        	...
			        	<div class="my_comment_list" v-for="(message,index) in tabs[0].list">
			        		...
			        		<div class="content" @click="goto(message.postid,message.postType)">
			        			<div class="content_detail">
				        			...
				        			<div class="bottom" v-if="message.groupid!=null">my comment: {{message.commentContent}}</div>
			        				<div class="my_post" v-if="message.groupid==null">My post: {{message.postTitle}}</div>
			        			</div>
			        		</div>
			        	</div>
			        </mescroll-vue>
		        ...
		        <swiper-slide>
		        	<mescroll-vue id="dataList1" ref="mescroll1" :up="getMescrollUp(1)" @init="mescrollInit(1,arguments)">
			        	<div class="like_list" v-for="(message,index) in tabs[1].list">
			        		...
			        		<div class="content" @click="goto(message.postid,message.postType)">
			        			<div class="content_detail">
				        			...
				        			<div class="text" v-if="message.type == 'post'">liked your post: {{message.postTitle}}</div>
				        			<div class="text" v-if="message.type != 'post'">liked your comment: {{message.commentContent}}</div>
			        			</div>
			        		</div>
			        	</div>
			        </mescroll-vue>
		        ...
		        <swiper-slide>
		        	<mescroll-vue id="dataList2" ref="mescroll2" :up="getMescrollUp(2)" @init="mescrollInit(2,arguments)">
