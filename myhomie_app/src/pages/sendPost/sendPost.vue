    ...
    <div class="content">
      ...
      <div class="back_block" v-show="isShow" @click="hidden">
          <div class="selection_box">
            <div class="select_list" v-for="(item, index) in category" :key="index" @click="select_click(item, index)">
              {{item.name}}
...
import {events,secondHand,marketing,recruitment,travel,rent,commonweal,others,discover} from '../../assets/sendPost.js';
