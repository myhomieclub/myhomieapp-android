    ...
    <section class="province">
        <div class="back_block">
            <div class="selection_box">
                <div class="select_list" v-for="(pro, index) in provinces" @click="select_pro(pro.name, index)"
                     v-show="show_pro">{{pro.name}}
                    <span class="select_btn"
                          :class="{isCheck: pro.isCheck}">
              </span>
                </div>
                <div class="select_list" v-for="(tem, index) in citys_temp.city" @click="select_city(tem.nam, index)"
                     v-show="show_city">{{tem.nam}}
