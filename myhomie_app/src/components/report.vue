<template>
    <div style="width:100%; max-width: 680px;">
        <van-popup v-model="show" @click-overlay="cancelReport" class="report"
                   style="width: 80%;padding: 15px;font-size: 14px;">
            <div class="report_title" style="font-size: 16px; line-height: 24px;margin-bottom: 10px;">
                {{$t('report.title')}}
            </div>
            ...
            <van-button @click="reportPostComment" class="report_button"
                        style="width:100%;background-color: #fe8f2d;color: #fff;margin-top: 10px;border-radius: 5px;">
                {{$t('report.report')}}
            </van-button>
        </van-popup>
    </div>
